...
reqLatencyCM = zeros(1,size(time,2));
reqLatencyMS = zeros(1,size(time,2));
...
for t = 1:tTime
  ...
  reqLatencyCM(t) = requestDB_T1{t,6};
  reqLatencyMS(t) = requestDB_T1{t,7};
...
plot(time,reqLatencyCM,'+','color', 'c');
hold on;
plot(time,reqLatencyMS,'*','color', 'm');
plot(time,averageLatency_T1,'s','color', 'r');
plot(time,minLatency_T1,'o','color', 'r');
plot(time,maxLatency_T1,'x','color', 'r');
plot(time,averageLatency_T2,'s','color', 'g');
plot(time,minLatency_T2,'o','color', 'g');
plot(time,maxLatency_T2,'x','color', 'g');
plot(time,averageLatency_T3,'s','color', 'b');
plot(time,minLatency_T3,'o','color', 'b');
plot(time,maxLatency_T3,'x','color', 'b');
xlabel('Request no.');
ylabel('Latency (ns)');
