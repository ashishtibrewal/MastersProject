    ...
    for x=1:10000%request(x)
        ...
        if y==1
            ...
            %new request.
             ...
             [resource,blocking,XT,LXPR,NumSlots,ReqNums,XTblock,EXTblock,linkblock,k_index,Bcauses(x,:)]=ff1XTnewcoreswitchKpaths2di_10m(BW(x),shortestpaths,link,resource,x,LXPR,NumSlots,linkblock,pathmemory,XT);
