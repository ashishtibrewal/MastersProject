            ...
            if sum==BW
              ...
              [n1,n2]=count7_2(resource,row,col,BW,a(ln),b(ln));  
               ...
               %  n1(n1>3)=3;
                ...
                XTperLink(ln)=(n1+0.5*n2-n1*exp(-(total_n+1)*h*link(a(ln),b(ln))*25000)- n2*exp(-(total_n+1)*h*link(a(ln),b(ln))*25000)*0.5)/(1+n1*exp(-(total_n+1)*h*link(a(ln),b(ln))*25000)+n2*exp(-(total_n+1)*h*link(a(ln),b(ln))*25000));
