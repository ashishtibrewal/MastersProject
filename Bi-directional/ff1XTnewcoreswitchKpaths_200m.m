        ...
        for i=1+(corenum-1)*200:corenum*200+1-BW
            ...
            if sum==BW
              ...
              %  XTperLink(ln)=(num-num*exp(-(num+1)*h*link(a(ln),b(ln))*1000))/(1+num*exp(-(num+1)*h*link(a(ln),b(ln))*1000));
                ...
                XTperLink(ln)=(n1+0.5*n2-n1*exp(-(total_n+1)*h*link(a(ln),b(ln))*20000)- n2*exp(-(total_n+1)*h*link(a(ln),b(ln))*20000)*0.5)/(1+n1*exp(-(total_n+1)*h*link(a(ln),b(ln))*20000)+n2*exp(-(total_n+1)*h*link(a(ln),b(ln))*20000));
