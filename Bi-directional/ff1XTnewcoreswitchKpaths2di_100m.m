function [resource,blocking,XTtotal,LXPR,NumSlots,ReqNums,XTblock,EXTblock,linkblock,k_index,Bcauses]=ff1XTnewcoreswitchKpaths2di(BW,kshortestpaths,link,resource,x,LXPR,NumSlots,linkblock,pathmemory,XTtotal)
...
for ln=1:n-1 %linknumber
    ...
    %7-3-5-10-12-14-1
     corecost(2)=10;corecost(4)=10;corecost(6)=10;corecost(8)=10;corecost(9)=10;corecost(13)=10;corecost(11)=10;
    ...
    if a(ln)>b(ln)
       k=a(ln);
        ...
        b(ln)=k;
        corecost=zeros(1,14);
        corecost(4)=inf;%corecost(7)=0; corecost(2)=0.5;
        %4-6-2-13-9-11-8
            ...
            if sum==BW
              ...
              [n1,n2]=count7_2(resource,row,col,BW,a(ln),b(ln));  
               ...
               %  n1(n1>3)=3;
                ...
                XTperLink(ln)=(n1+0.5*n2-n1*exp(-(total_n+1)*h*link(a(ln),b(ln))*10000)- n2*exp(-(total_n+1)*h*link(a(ln),b(ln))*10000)*0.5)/(1+n1*exp(-(total_n+1)*h*link(a(ln),b(ln))*10000)+n2*exp(-(total_n+1)*h*link(a(ln),b(ln))*10000));
