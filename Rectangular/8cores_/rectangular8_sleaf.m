% Comparision of all new algorithm2
% 19cores 
% Typical 3spin 20leaf topology
...
for y=1:1
      % y=1  '2di priority core switch spectrum split'
    % y=2  '2di priority core switch spectrum split 3 paths '
    % y=3  '2di priority core switch slot split spectrum split'
    % y=4  '2di priority core switch slot split spectrum split 3 paths '
    % y=5  '2di priority core switch spectrum hard split 3 paths'
