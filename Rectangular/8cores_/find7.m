...
if row==9
   x(1)=NumSlots(10,column,a,b);
   x(2)=NumSlots(15,column,a,b);
   x(3)=NumSlots(16,column,a,b);
...
if row==10
        ...
        x(3)=x(3)+NumSlots(16,column,a,b);
...
if row==11
        ...
        x(1)=x(1)+NumSlots(14,column,a,b);
...
if row==12
        x(1)=x(1)+NumSlots(13,column,a,b);
        x(2)=x(2)+NumSlots(11,column,a,b);
