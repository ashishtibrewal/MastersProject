function [resource,blocking,XTtotal,LXPR,NumSlots,ReqNums,XTblock,EXTblock,linkblock,XTeach]=ff1XTnewcoreswitchsplit2di(BW,path,link,resource,x,LXPR,NumSlots,linkblock,pathmemory,XTtotal,XTeach)
XTblock=0;
EXTblock=0;
blocking=0;
n=length(path);
