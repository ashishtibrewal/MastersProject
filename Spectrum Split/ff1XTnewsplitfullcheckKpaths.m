function [resource,blocking,LXPR,NumSlots,ReqNums,XTblock,EXTblock,linkblock,XTeach,k_index,Bcauses]=ff1XTnewsplitfullcheckKpaths(BW,kshortestpaths,link,resource,x,LXPR,NumSlots,linkblock,pathmemory,XTeach)
XTblock=0;
EXTblock=0;
          ...
          for k=i:i+2-1
            ...
            if length(ReqNums)~=1
                ...
                if upblocking~=0
                    ...
                    [resource,LXPR,NumSlots,linkblock]=ff1XTconvertDBsfull(kshortestpaths{y},resource,x,LXPR,NumSlots,linkblock,t);
...
if blocking==1
    ...
    [resource,LXPR,NumSlots,linkblock]=ff1XTconvertDBs(kshortestpaths{y},resource,x,LXPR,NumSlots,linkblock,t-1);
    break
end
