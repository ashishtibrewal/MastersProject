function [resource,blocking,LXPR,NumSlots,ReqNums,XTblock,EXTblock,linkblock,XTeach]=ff1XTnewsplitfullcheck(BW,path,link,resource,x,LXPR,NumSlots,linkblock,pathmemory,XTeach)
XTblock=0;
EXTblock=0;
blocking=0;
n=length(path);
