function [resource,blocking,XTtotal,LXPR,NumSlots,ReqNums,XTblock,EXTblock,linkblock]=ff1XTnewFF(BW,path,link,resource,x,LXPR,NumSlots,linkblock,pathmemory,XTtotal)
XTblock=0;
EXTblock=0;
blocking=0;
n=length(path);
